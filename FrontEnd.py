...
def Car_values():
    ...
    tk.Label(frame7, text="Incentive Calculator", font=("Helvetica", 50), bg="cyan").grid(row=0, column=0,
                                                                                          columnspan=4)
...
def About():
    ...
    tk.Label(frame5, text='@2017 All Copyrights Reserved', font=('Helvetica', 12))\
